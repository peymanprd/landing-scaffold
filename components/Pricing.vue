  ...
  <div class="overflow-hidden">
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="relative xl:w-10/12 xl:mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          <div>
            ...
            <div class="p-4 relative z-10 bg-white border rounded-xl md:p-10">
              ...
              <div class="mt-5">
                <span class="text-6xl font-bold text-gray-800">$18</span>
              ...
              >
                ...
                <ul class="space-y-2 text-sm sm:text-base">
                  <li class="flex space-x-3">
                    <span
                      class="mt-0.5 h-5 w-5 flex justify-center items-center rounded-full bg-blue-50 text-blue-600"
                    >
                      <svg
                    ...
                    <span class="text-gray-800"> Up to 10 people </span>
                  </li>
                ...
                <ul class="space-y-2 text-sm sm:text-base">
                  <li class="flex space-x-3">
                    <span
                      class="h-5 w-5 flex justify-center items-center rounded-full bg-gray-50 text-gray-500"
                    >
                      <svg
                        class="flex-shrink-0 h-3.5 w-3.5"
                        xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            <!-- Card -->
            <div
              class="shadow-xl shadow-gray-200 p-5 relative z-10 bg-white border rounded-xl md:p-10"
            >
              <h3 class="text-xl font-bold text-gray-800">Teams</h3>
              ...
              <div class="mt-5">
                <span class="text-6xl font-bold text-gray-800">$36</span>
        ...
        <!-- SVG Element -->
        <div
          class="hidden md:block absolute top-0 end-0 translate-y-16 translate-x-16"
        >
          <svg
        ...
        <!-- SVG Element -->
        <div
          class="hidden md:block absolute bottom-0 start-0 translate-y-16 -translate-x-16"
        >
          <svg
