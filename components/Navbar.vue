    ...
    <div class="relative md:flex md:items-center md:justify-between">
      ...
      >
        ...
        >
          ...
          >
            <a
              class="font-medium text-blue-600 py-3 md:py-6"
              href="#"
              aria-current="page"
              >Landing</a
            >
            ...
            <a
              class="font-medium text-gray-800 hover:text-gray-600 py-3 md:py-6"
              href="#"
            >
              Company
            </a>
            ...
            <div class="pt-3 md:pt-0">
              <a
                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-gray-100 text-gray-900 hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                href="#"
              >
                Request demo
              </a>
